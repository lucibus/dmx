...
import (
	...
	"github.com/lucibus/lige/output"
)

// Takes json that is a flat map of int -> int and turns it into a Go map
func jSONIntByteMap(b io.ReadCloser) (m map[int]byte, err error) {
...
func makeHandler(o output.OutputDevice) http.HandlerFunc {
